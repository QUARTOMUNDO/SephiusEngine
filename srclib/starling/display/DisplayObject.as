...
package starling.display
{
    ...
    public class DisplayObject extends EventDispatcher
    {
                                                ...
                                                resultMatrix:Matrix=null):Matrix
        {
			...
			//Hack, avoid game to crash if damager try collision with a removed object
            if(!commonParent)
				return null;
         ...
         *  If you pass a 'resultPoint', the result will be stored in this point instead of 
         *  creating a new object. */
        public function localToTarget(targetSpace:DisplayObject, localPoint:Point, resultPoint:Point=null):Point
        {
			getTransformationMatrix(targetSpace, sHelperMatrixAlt);
			return MatrixUtil.transformPoint(sHelperMatrixAlt, localPoint, resultPoint);
        }
