...
package starling.textures
{
    ...
    public class Texture
    {
        ...
        /** Creates a texture from a config. If you don't want to use any embedded
         *  mipmaps, you can disable them by setting "useMipMaps" to <code>false</code>.
         *  Beware: you must not dispose 'data' if Starling should handle a lost device context;
         *  alternatively, you can handle restoration yourself via "texture.root.onRestore".
         *  
         ...
         *  asynchronously. It can only be used when the callback has been executed. This is the
         *  expected function definition: <code>function(texture:Texture):void;</code></p> */
        public static function fromConfig(config:NativeTextureConfig):Texture
        {
            var context:Context3D = Starling.context;
            if (context == null) throw new MissingContextError();
            
            var concreteTexture:ConcreteTexture = new ConcreteTexture(null, null, 
                config.width, config.height, config.mipMapping, 
                config.premultipliedAlpha, false, config.scale, config.repeat);
        ...
        public function set frame(value:Rectangle):void { mFrame = value; }
