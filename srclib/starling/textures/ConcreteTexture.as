...
package starling.textures
{
    ...
    public class ConcreteTexture extends Texture
    {
        ...
        public function uploadAtfData(data:ByteArray, offset:int=0, async:*=null):void
        {
			...
			mFormat = atfData.format;
			mMipMapping = mMipMapping && (atfData.numTextures > 1);
			...
			function onTextureReady(event:Object):void
			{
				...
				//trace("[ConcreteTexture] texture is ready");
				callback = async as Function;
				if (callback != null)
				{
         ...
         *  the current base. */
        starling_internal function createBase(rectangle:Boolean = true):void
        {
            var context:Context3D = Starling.context;
           Stage3D
            if (mBase is flash.display3D.textures.Texture || !rectangle)
