...
package starling.filters
{
    ...
    public class BlurFilter extends FragmentFilter
    {
         ...
         *  cost.</p>
         */
        public function BlurFilter(blurX:Number=1, blurY:Number=1, resolution:Number=1, blendMode:String=BlendMode.NORMAL, mode:String = FragmentFilterMode.REPLACE, color:int = 0x0)
        {
            super(1, resolution);
            mBlurX = blurX;
            mBlurY = blurY;
