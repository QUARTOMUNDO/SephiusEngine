...
package starling.filters
{
     ...
     */
    public class FullScreenBlurFilter extends FragmentFilter
    {
         ...
         *  cost.</p>
         */
        public function FullScreenBlurFilter(blurX:Number=1, blurY:Number=1, resolution:Number=1, blendMode:String=BlendMode.NORMAL, mode:String = FragmentFilterMode.REPLACE, color:int = 0x0)
        {
            super(1, resolution);
            mBlurX = blurX;
            mBlurY = blurY;
        ...
        private function createProgram(tinted:Boolean):Program3D
        {
            ...
            if (target && target.hasProgram(programName))
