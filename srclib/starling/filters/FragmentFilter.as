...
package starling.filters
{
    ...
    {
		/** If true filter will not process or cache regions outside screen */
		protected var isFullscreenFX:Boolean = false
		...
		protected var mBlendMode:String = BlendMode.NORMAL;
		...
		public static var filtersNotDisposed:Vector.<FragmentFilter> = new Vector.<FragmentFilter>();
        ...
        {
			filtersNotDisposed.splice(filtersNotDisposed.indexOf(this), 1);
                                      ...
                                      parentAlpha:Number, intoCache:Boolean=false):QuadBatch
        {
			...
			//hack. avoid too big textures. max of 2048 for width and 1024 for height
					//boundsPot.height = boundsPot.height  > 1024 ? 1024 :  boundsPot.height;
					//boundsPot.width = boundsPot.width  > 2048 ? 2048 :  boundsPot.width;
			//boundsPot.height = 1024;
                                         ...
                                         resultPotRect:Rectangle):void
        {
            ...
            {    
				...
				if (isFullscreenFX){
                    // optimize for full-screen effects
                    resultPotRect.width = stage.stageWidth;
                    resultPotRect.height = stage.stageHeight;
                }
