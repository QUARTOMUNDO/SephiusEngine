package starling.extensions.lighting.core
{
  ...
  public class LightLayer extends DisplayObject
  {
    ...
    private function createScene():void
    {
      ...
      lightMapIn = context.createTexture(legalWidth * .125, legalHeight * .125, Context3DTextureFormat.BGRA, true);
      lightMapOut = context.createTexture(legalWidth * .5, legalHeight * .5, Context3DTextureFormat.BGRA, true);
    ...
    private function createShaders():void
    {
      ...
      blurShader = new GaussianBlurShader(legalWidth * .5, legalHeight * .5, _shadowSoftness >= 1 ? _shadowSoftness : 0);
    ...
    private function shadowPass(support:RenderSupport, light:LightBase, context:Context3D):void
    {
      switch (true)
      {
        case light is PointLight: 
          if((light as PointLight).castShadow){
