...
package starling.extensions.particles
{
    ...
    public class ParticleSystem extends DisplayObject implements IAnimatable
    {
		...
		private var nextParticle:Particle;
        ...
        public function removeParticle(aParticle:Particle):void {
			if (mNumParticles == 0)
				return;
			lastParticle = mParticles[int(mNumParticles-1)] as Particle;
			mParticles[int(mNumParticles - 1)] = aParticle;
			mParticles[mParticles.indexOf(aParticle)] = lastParticle;
			ParticlePool.returnObject(aParticle as EssenceParticle);
			--mNumParticles;
		}
        ...
        public function advanceTime(passedTime:Number):void
        {
            ...
            {
                vertexID = k << 2;
                particle = mParticles[k] as Particle;
