...
package starling.core
{
    ...
    public class Starling extends EventDispatcher
    {
        ...
        private function requestContext3D(stage3D:Stage3D, renderMode:String, profile:Object):void
        {
            ...
            if (profile == "auto")
                profiles = ["enhanced", "standardExtended", "standardConstrained", "standard", "baselineExtended", "baseline", "baselineConstrained"];
            ...
            //mStage3D.requestContext3DMatchingProfiles();
            requestNextProfile();
            Context3DProfile
		 ...
		 * ATTENTION: NEXT FRAME IS CALLED BY GAME STATE AND GAME ENGINE IN ORDER TO MATCH UPDATES WITH GAME LOGIC.
		 * OTHERWISE STARLING COULD UPDATE LESS OFTEN THAN GAME STATE CAUSING SOME LOGIC GET OBSOLETE VALUES FROM STARLNG OBJECTS WITCH WAS NOT YET UPDATED
         *  and <code>render()</code>. */ 
        public function nextFrame(passedTime:Number):void
        {
            //var now:Number = time;
		 ...
		 * ATENTION: RENDER IS CALLED BY GAME ENGINE NOT FROM INSIDE STARLING CLASS.
		 * RENDER SHOULD NOT BE CALLED WITH nextFrame() CAUSED THIS METHOD COULD BE UPDATED MORE OFTEN THAN 1 TIME PER ENTER FRAME.
		 * SO WE DO NOT WANT GAME RENDER SCENE MORE TIMES THAN WHAT IS NECESSARY
        ...
        private function updateViewPort(forceUpdate:Boolean=false):void
        {
                ...
                mPreviousViewPort.x != mViewPort.x || mPreviousViewPort.y != mViewPort.y)
            {
                ...
                if (!mShareContext)
                {
                    ...
                    trace("Starling AA", mAntiAliasing);
        ...
        public function updateNativeOverlay():void
        {
		...
		/**ATENTION: THIS FUNCTION IS NOT USED ANYMORE. 
		 * nextFrame() AND render() IS NOW CALLED BY GAME ENGINE AND GAME STATE*/
