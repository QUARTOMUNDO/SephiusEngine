package SephiusEngine.userInterfaces {
	...
	public class NewNatureUI extends Sprite{
        ...
        private function setLayout():void{
            ...
            rewardName.x = (frame.width / 2) - (rewardName.width / 2) - 7;
        ...
        public function update():void{
            ...
            if(inputWatcher.justDid(InputActionsNames.INTERFACE_MENU_INFO)){
                UserInterfaces.instance.gameMenu.show(skin, "SPEELS", nature);
                hide();
            }
        ...
        public function updateLang(langID:String):void{
            ...
            var langCategory:String = "SpellData";

            rewardName.text = LanguageManager.getLoreLang(langCategory, nature).name;
            rewardName.alignPivot();
            
            usageText.text = LanguageManager.getLoreLang(langCategory, nature).usage;
            usageText.alignPivot();
        ...
        public function show(nature:String, parent:Sprite):void{
            ...
            iconTextName = "SpellIcon_" + skin + nature;
