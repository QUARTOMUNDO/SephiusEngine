package SephiusEngine.input.controllers {
	...
	public class Keyboard extends InputController{
		...
		public function Keyboard(name:String, params:Object = null){
			...
			_ge.stage.addEventListener(KeyboardEvent.KEY_DOWN, onKeyDown);
			_ge.stage.addEventListener(KeyboardEvent.KEY_UP, onKeyUp);
		}
		...
		override public function destroy():void{
			_ge.stage.removeEventListener(KeyboardEvent.KEY_DOWN, onKeyDown);
			_ge.stage.removeEventListener(KeyboardEvent.KEY_UP, onKeyUp);
